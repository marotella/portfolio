            ...
            <Header/>
                ...
                >
                    ...
                    <div className="md:w-2/3 md:mr-8 md:object-left p-4">
                        ...
                        <p className="mt-2 md:text-lg md:text-left font-[600]">Linked <Link className="font-[600] text-green hover:underline hover:underline-offset-4 md:hover:underline-offset-8 hover:text-white" to="/projects">here</Link> are some recent solo and group projects.</p>
                    </div>
                </section>
